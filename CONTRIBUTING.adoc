...
.Prerequisites
 - Java 11, up to 21.
 - Gradle 8.14. Use the provided `gradlew` script!
...
TIP: You may use link:https://github.com/kordamp/gm[] instead in which case the commands are shorter, for example
...
Use of GenAI is **NOT** allowed until further notice.

...
- The JReleaser source code, documentation, and build pipelines.
- Release artifacts.
- The main website ([https://jreleaser.org](https://jreleaser.org)).
- Any official JReleaser GitHub organization infrastructure.
...
- **Incident**: Any event that could compromise the confidentiality, integrity, or availability of JReleaser code, releases, or users. Examples include:
...
In practice, JReleaser’s core team fulfills these roles collectively, assigning an IC on a per-incident basis.
...
1. A maintainer acknowledges receipt within 3 business days (or sooner, when possible).
   JReleaser is maintained by a small volunteer team; response times may vary slightly outside normal working hours.
...
- [JReleaser GitHub discussions](https://github.com/jreleaser/jreleaser/discussions)
...
JReleaser follows a responsible disclosure approach:
...
| GitHub discussion alerts | [github.com/jreleaser/jreleaser/discussions](https://github.com/jreleaser/jreleaser/discussions) |
...
_The JReleaser maintainers are committed to transparency, user trust, and continuous improvement in our security and response practices._
